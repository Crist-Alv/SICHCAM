...
function Header()
{
  ...
  $this->Text(58, 15, 'CUERPO DE AGENTES MUNICIPALES - (CAM)');
  $this->Text(54, 20, 'ALCALDIA MUNICIPAL DE SAN RAFAEL CEDROS');
...
$pdf->Text(80, 50, 'Tabla Listado de Usuarios');
$pdf->Ln(5);
/* --- Tabla --- */

$pdf->SetX(28);
$pdf->SetFont('', 'B', 11);
$pdf->Cell(35, 8, 'Nombre', 0, 0, 'C', 0);
$pdf->Cell(50, 8, utf8_decode('Correo Eléctronico'), 0, 0, 'C', 0);
$pdf->Cell(25, 8, 'Genero', 0, 0, 'C', 0);
$pdf->Cell(27, 8, utf8_decode('Rol'), 0, 0, 'C', 0);
$pdf->Cell(15, 8, 'Estado', 0, 1, 'C', 0);
/* --- DIVISION --- */
$pdf->setDrawColor(24,68,104);
$pdf->Line(28, 62, 180, 62);
$pdf->SetFillColor(240,240,240);
$pdf->SetDrawColor(255,255,255);
/* --- Tabla --- */

$pdf->SetFont('Arial','',10);
$pdf->SetWidths(array(35,50,25,27,15));
$query_s = mysqli_query($conexion,"SELECT * FROM tbl_usuario ORDER BY estado=1 DESC");
...
$pdf->SetX(25);
$pdf->Row(array(utf8_decode($array['nombre_User']), utf8_decode($array['correo_User']), utf8_decode($array['sexo_User']), utf8_decode($array['rol_User']), $estado));
}
