...
<head>
    ...
    <body>
        ...
        $arquivo = 'Tabla_de_Horarios.xls';

        // Crear la tabla HTML
        $html = '';
        $html .= '<table border="1">';
        $html .= '<tr>';
        $html .= '<td colspan="6">Tabla de Horarios</tr>';
        $html .= '</tr>';
        ...
        $result_msg_contatos = "SELECT * FROM horario where fecha_horario = DATE(NOW()) ORDER BY agenteh ASC";
