            ...
            <div class="media-body">
                ...
                <div class="collapse navbar-collapse" id="navbar-collapse">
                    <ul class="nav navbar-nav navbar-right">
                        <a href="include/ayuda/Agentes.pdf" target="_blank" title="Ayuda">
                                        ...
                                        <div class="row form-group col-md-8">
                                            ...
                                            <div class="col-sm-3" style="width : 158px">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="String" class="codigo-agente-number" style="width : 80px" name="codigo" id="codigo" autocomplete="off" autofocus>
                                                </div>
                                            </div>
