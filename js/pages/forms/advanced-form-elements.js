$(function () {
    ...
    //Mobile Phone Number
    $demoMaskedInput.find('.mobile-phone-number').inputmask('9999-99-99', { placeholder: '____-__-__' });
    //Phone Number
    ...
    //NIT
    $demoMaskedInput.find('.nit-number').inputmask('9999-999999-999-9', { placeholder: '____-______-___-_' });
